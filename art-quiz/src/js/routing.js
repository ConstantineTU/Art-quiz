	...
	async locationResolver(location, info) {
		...
		if (location === "#/artist/") {
			...
			if (+location.split('-', 3)[2].split('/', 1) + 1 < 12) {
				this.modalButtonNextQuiz.parentElement.href = `#/artist-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
				this.modalButtonNextQuiz.parentElement.dataset.href = `#/artist-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
			...
			<div class="questions-author">
							<div class="questions-author-container">
								...
								<div class="questions-author-picture" style="background: url('${this.picture}') no-repeat scroll center center /contain;"></div>
								...
								<div class="questions-author-answers">
									<a href="#/artist-question-${location.split('-', 3)[2].split('/', 1)}/" data-href="#/artist-question-${location.split('-', 3)[2].split('/', 1)}/">
			...
			if (+location.split('-', 3)[2].split('/', 1) + 1 < 24) {
				this.modalButtonNextQuiz.parentElement.href = `#/picture-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
				this.modalButtonNextQuiz.parentElement.dataset.href = `#/picture-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
				this.modalButtonNextQuiz.onclick = () => {
					this.modalEnd.style.zIndex = -1
					this.modalButtonNextQuiz.parentElement.href = `#/picture-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
					this.modalButtonNextQuiz.parentElement.dataset.href = `#/picture-question-${+location.split('-', 3)[2].split('/', 1) + 1}/`
			...
			<div class="questions-picture-container">
				...
				<div class="questions-picture-answers">
					<a href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/" data-href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/">
					<div class="questions-picture-answer"><img class="questions-picture-answer-img" src="${this.randomPictures[0]}" alt=""></div>
					</a>
					<a href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/" data-href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/">
					<div class="questions-picture-answer"><img class="questions-picture-answer-img" src="${this.randomPictures[1]}" alt=""></div>
					</a>
					<a href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/" data-href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/">
						<div class="questions-picture-answer"><img class="questions-picture-answer-img" src="${this.randomPictures[2]}" alt=""></div>
					</a>
					<a href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/" data-href="#/picture-question-${location.split('-', 3)[2].split('/', 1)}/">
					<div class="questions-picture-answer"><img class="questions-picture-answer-img" src="${this.randomPictures[3]}" alt=""></div>
					</a>
				</div>
